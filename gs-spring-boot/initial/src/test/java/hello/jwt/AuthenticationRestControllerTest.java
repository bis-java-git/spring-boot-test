...
import hello.JwtTokenUtil;
import hello.controller.JwtRequest;
import hello.service.JwtUserDetailsService;
...
public class AuthenticationRestControllerTest {
    ...
    public void successfulAuthenticationWithAnonymousUser() throws Exception {
        ...
        JwtRequest jwtAuthenticationRequest = new JwtRequest("user", "password");
